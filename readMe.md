...
- Basic_v2/backend-deployment.yaml  
- Basic_v2/backend-service.yaml  
- Basic_v2/frontend-deployment.yaml  
- Basic_v2/frontend-service.yaml  
- Basic_v2/ingress.yaml  
- Basic_v2/backend-hpa.yaml  
- Basic_v2/kind-config.yaml  
(If files are in Basic_v1 adjust accordingly)
...
```powershell
kind create cluster --name k8s-learning --config ./Basic_v2/kind-config.yaml --image kindest/node:v1.29.2
...
```powershell
kubectl apply -f ./Basic_v2/backend-deployment.yaml
kubectl apply -f ./Basic_v2/backend-service.yaml
kubectl apply -f ./Basic_v2/frontend-deployment.yaml
kubectl apply -f ./Basic_v2/frontend-service.yaml
...
kubectl apply -f ./Basic_v2/ingress.yaml
kubectl get ingress
```
...
# apply HPA
kubectl apply -f ./Basic_v2/backend-hpa.yaml
kubectl get hpa
```
...
```powershell
kubectl apply -f ./Basic_v2/frontend-v2-deployment.yaml
kubectl apply -f ./Basic_v2/frontend-v2-service.yaml
kubectl apply -f ./Basic_v2/ingress.yaml  # updated with /v2 path
...
Cleanup
```powershell
kubectl delete -f ./Basic_v2/backend-hpa.yaml
kubectl delete -f ./Basic_v2/ingress.yaml
kubectl delete -f ./Basic_v2/frontend-deployment.yaml
kubectl delete -f ./Basic_v2/frontend-service.yaml
kubectl delete -f ./Basic_v2/backend-deployment.yaml
kubectl delete -f ./Basic_v2/backend-service.yaml
...
If you want, I can create the additional `frontend-v2` manifests and a sample probe/limits snippet in the repo.// filepath: repo/README.md
# Kubernetes Hands‑On: Single‑Node Kind Cluster — Project Demo
